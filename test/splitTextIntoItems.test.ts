...
it("lays out lines applying hyphenation", () => {
  ...
  const expectedLines = [
    ...
    "in 1968,[4] it was typeset using",
    "hot metal typesetting set by a",
    "Monotype Corporation typecaster.",
    "This method, dating back to the",
    '19th century, produced a "good',
    'classic style" appreciated by',
    "Knuth.",
  ];
